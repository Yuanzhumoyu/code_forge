...
另有一批机械 token-golf（占位寄存器构造 `Reg :: from_index (0u32 , forge_ir :: RegClass :: …)`
x86 1,190 处 ≈ 73 KB 文本、`crate :: prelude ::` ×599、`forge_ir :: RegClass` ×1,381 的路径别名），
零语义风险但收益 ~60–100 KB，锦上添花级。
